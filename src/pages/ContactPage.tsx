  ...
  return (
    <>
      <div>
        ...
        {/* الزر بقسم الكتب  */}
        <ButtonCommon
          contentBtn={"Download Ebooks Now"}
          imgArrowbtn={imgArrowHero}
          altimagebtn={"image"}
          hiddenEyes={"hiddenEyes"}
          EbookHome="EbookHome"
        ...
        <ButtonCommon
          ResourseDepthReportsActive="ResourseDepthReportsActive"
          contentBtn="Whitepapers"
          hiddenArrow="hiddenArrow"
          hiddenEyes="hiddenEyes"
        />
        ...
        <ButtonCommon
          ResourseDepthReports="ResourseDepthReports"
          contentBtn="Ebooks"
          hiddenArrow="hiddenArrow"
          hiddenEyes="hiddenEyes"
        />
        ...
        <ButtonCommon
          herobtnAndCommon={"herobtnAndCommon"}
          contentBtn={"contact@ai-podcasts.com"}
          imgArrowbtn={imgArrowHero}
          altimagebtn={"image"}
          hiddenEyes={"hiddenEyes"}
