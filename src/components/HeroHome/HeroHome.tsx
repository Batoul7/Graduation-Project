...
export default function HeroHome({ HeroCard, par1, title, par2, img1, altimg1, subtitle, par3, contentBtn, imgArrowbtn, altimagebtn, imgEyes, parResponsive }: HeroProps) {
    ...
    return (
        <div className="2xl:h-2xl-hero min-h-md-hero 2xl:mt-[107px] mt-[77px] px-4 xl:px-20 2xl:px-mainpaddinglarge bg-myprimary-dark-08 flex flex-wrap overflow-hidden">
