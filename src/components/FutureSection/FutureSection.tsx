...
export default function FutureSection({ cardsData , title , description , icon   }: FutureCardsProps): JSX.Element {
    return (
        <div className="bg-myprimary-dark-08 border-neutral-800 border-y px-4 xl:px-20 2xl:px-mainpaddinglarge flex flex-wrap justify-center items-center lg:flex-nowrap ">
