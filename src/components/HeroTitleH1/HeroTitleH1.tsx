...
export default function HeroTitleH1({title , mainhero , newcommonhero , podcastcommonhero , Resourcecommonhero} : HeroTitleProps ) {
  return (
    <h1 className={`font-medium font-kumbhSans text-white ${mainhero ? 'pb-2  xl:pb-3 2xl:pb-5 text-3xl lg:text-5.5xl 3xl:text-[70px]  leading-9 lg:leading-[66px] 3xl:leading-[84px] ' : ''}
