...
export default function ButtonCommon({
  ...
  hiddenEyes,
  footerBtn,
  ResourseDepthReportsActive,
  ResourseDepthReports,
  ResourseCardBook,
  ResourseCardBookActive,
  widthSmall,
  onClick, 
}: BtnProps) {
  return (
    <button
      className={`whitespace-nowrap text-myprimary-gray-60 font-normal rounded-xl border border-solid border-neutral-800 text-sm 2xl:text-lg font-inter leading-5 2xl:leading-[27px]
