...
<div className={`fixed top-0 w-full ${nav?'h-screen':'h-max'}`}>
        <div className=' px-4 flex items-center justify-center bg-myprimary-dark-08 py-5  border border-neutral-800 '>
            ...
            <div className='w-5 h-5 lg:w-6'>
                <img src={OSgoArrow} alt="goArrow" />
             </div>
        </div>
        
     <div className={` ${nav?'h-full':'h-max'} 2xl:px-mainpaddinglarge lg:py-6 xl:px-20 md:py-5 px-4 flex justify-between md:items-center lg:items-center text-myprimary-gray-50 bg-neutral-800 `}>
