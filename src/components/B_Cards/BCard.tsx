...
export default function BCard({ icon, title, subtitle, text, BePart }: BCardProps) {
  return (
    <div
      data-aos="fade-up"
      className={`flex flex-col gap-7.5 md:w-[45%] ${BePart ? 'bg-myprimary-dark-10 rounded-xl border-[1px] border-myprimary-dark-20 2xl:p-10 md:p-[30px] p-6 2xl:w-[505.33px] lg:w-[413.33px] w-full justify-between'
