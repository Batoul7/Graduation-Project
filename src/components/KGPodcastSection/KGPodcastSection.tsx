...
export default function KGPodcastSection( {title , description , host , rating , first } :RightPodcast ) {
  ...
  return (
    <section className="px-4 xl:px-20 2xl:px-mainpaddinglarge bg-myprimary-dark-08 flex flex-wrap lg:flex-nowrap justify-start lg:justify-between items-center gap-[60px] xl:gap-[120px] lghero:gap-[50px] 2xl:gap-[160px] py-[80px] ">
      {firstPodcast && (
        <LeftCard 
          title={title}
