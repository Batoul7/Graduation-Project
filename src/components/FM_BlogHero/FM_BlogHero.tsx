...
export default function FM_BlogHero({img, title} : BlogHero) {
    return (
        <section className='2xl:px-mainpaddinglarge xl:px-[80px] px-4 2xl:h-2xl-hero xl:h-xl-hero h-md-hero 2xl:mt-[107px] xl:mt-[84px] mt-[77px] relative flex items-end justify-center'>
