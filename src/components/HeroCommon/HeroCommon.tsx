...
export default function HeroCommon({ CommonHeroTitle, CommonHeroText, neww, podcast, Resourse, newcommonhero, podcastcommonhero, Resourcecommonhero }: HeroCommonProps) {
  return (
    <div className="px-4 xl:px-20 2xl:px-mainpaddinglarge bg-myprimary-dark-08 2xl:h-2xl-hero h-md-hero 2xl:mt-[107px] mt-[77px] flex items-start  sm:items-center pt-10 xl:pt-20 2xl:pt-[130px] sm:pt-0 ">
