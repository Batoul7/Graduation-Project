  ...
  return (
    <>
        {HeroCard?.map((item: HeroCard ,index: number) => (
            <div key={index} className="sm:w-73 py-5 xl:py-7.5 2xl:py-13 ps-5 sm:ps-13 border-neutral-800 border-l ">
                <div className="flex font-semibold pb-0.5 2xl:pb-2.5 text-2xl xl:text-3xl 2xl:text-4.5xl leading-9 xl:leading-10.5 2xl:leading-11 ">
